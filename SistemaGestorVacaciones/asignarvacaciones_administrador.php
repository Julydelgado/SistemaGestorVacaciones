...
if (isset($_POST["asignar"])) {
    ...
    $fecha_act = $fecha_actual->format("Y-m-d"); // Formato '2024-12-07'
    ...
    if ($verificarResult->num_rows > 0) {
        ...
        $insertQuery = "INSERT INTO solicitudes_vacaciones (empleado_id, days, fecha_inicio, fecha_end, fecha_act, estado) VALUES (?, ?, ?, ?, ?, ?)";
        $insertStmt = $conn->prepare($insertQuery);
        $insertStmt->bind_param("iissss", $employeeId, $days, $fecha_inicio, $fecha_end, $fecha_act, $estado);
