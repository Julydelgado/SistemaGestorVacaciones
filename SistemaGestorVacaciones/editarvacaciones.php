...
if (isset($_POST["modificar"])) {
    ...
    $fecha_act = date("Y-m-d"); // Obtiene la fecha en formato 'hoy'

    
    // Actualizar los datos de la solicitud de vacaciones en la tabla de solicitudes_vacaciones
    $updateQuery = "UPDATE solicitudes_vacaciones SET days = ?, fecha_inicio = ?, fecha_end = ?, fecha_act = ? WHERE id = ?";
    $updateStmt = $conn->prepare($updateQuery);
    $updateStmt->bind_param("isssi", $days, $fecha_inicio, $fecha_end, $fecha_act, $vacationId);
    ...
    <div class="container mt-5">
        ...
        <form method="post">
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control" id="fecha_inicio" name="fecha_inicio" required min="<?php echo date('Y-m-d'); ?>" value="<?php echo $vacationFechaInicio; ?>">
            </div><br>
